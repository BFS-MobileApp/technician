...
class CancelledClaimsScreen extends StatefulWidget {
  String referenceId;
  String claimId;
  CancelledClaimsScreen({super.key , required this.referenceId , required this.claimId});

  @override
  State<CancelledClaimsScreen> createState() => _CancelledClaimsScreenState();
}

class _CancelledClaimsScreenState extends State<CancelledClaimsScreen> {
